...
Rules:
- Story body: 180 to 220 words (short enough to fit in one API response)
- First-person, past tense, emotionally engaging
- Clear setup, conflict, and resolution or twist
- No "Edit:" sections, no usernames, no markdown in the story text
- Title should be a Reddit-style question or statement"""
    ...
    data = json.loads(raw)  # responseMimeType guarantees clean JSON
